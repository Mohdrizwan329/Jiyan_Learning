...
import 'package:learning_a_to_z/view%20model/learn%20set%20controller/colors_learning_controller.dart';
...
class ColorsLearningPage extends StatefulWidget {
  const ColorsLearningPage({super.key});

  @override
  State<ColorsLearningPage> createState() => _ColorsLearningPageState();
}

class _ColorsLearningPageState extends State<ColorsLearningPage>
    with SingleTickerProviderStateMixin {
  final ColorsLearningController controller = Get.put(
    ColorsLearningController(),
  );

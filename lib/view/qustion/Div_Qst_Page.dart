...
class _DivisionQuestionsScreenState extends State<DivisionQuestionsScreen> {
  final List<QuestionModel> _questions = List.generate(50, (_) {
    final rand = Random();
    int divisor = rand.nextInt(89) + 10; // 10–99
    int quotient = rand.nextInt(89) + 10; // 10–99
    int dividend = divisor * quotient;
    return QuestionModel(
      dividend,
      divisor,
    ); // so dividend ÷ divisor = quotient (no remainder)
  });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Division Questions (10 at a time)'),

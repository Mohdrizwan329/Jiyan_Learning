...
class _AdditionQuestionsScreenState extends State<AdditionQuestionsScreen> {
  final List<QuestionModel> _questions = List.generate(50, (_) {
    final rand = Random();
    final num1 = rand.nextInt(90) + 10;
    final num2 = rand.nextInt(90) + 10;
  ...
  void _checkAnswer(int index) {
    ...
    if (userAnswer != null) {
      ...
      // If all 10 in current batch are answered
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Addition Questions (10 at a time)'),
      ...
      body: GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          // Show locked only for unanswered + not in batch

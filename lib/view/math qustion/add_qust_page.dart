...
class _AdditionQuestionsScreenState extends State<AdditionQuestionsScreen>
  ...
  final AdditionQuestionsController controller = Get.put(
    AdditionQuestionsController(),
  );

  late AnimationController _animationController;
  late Animation<double> _floatAnimation;

  /// Selected indexes (like HindiLettersPage)
              ...
              children: [
                ...
                GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    /// Locked card if not in current batch

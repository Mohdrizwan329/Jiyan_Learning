...
class _SubtractionQuestionsScreenState extends State<SubtractionQuestionsScreen>
    with SingleTickerProviderStateMixin {
  final SubtractionQuestionsController controller = Get.put(
    SubtractionQuestionsController(),
  );

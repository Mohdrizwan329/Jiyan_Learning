...
import 'package:learning_a_to_z/view%20model/learn%20set%20controller/bodyparts_learning_controller.dart';
...
class BodyPartsLearningPage extends StatefulWidget {
  const BodyPartsLearningPage({super.key});

  @override
  State<BodyPartsLearningPage> createState() => _BodyPartsLearningPageState();
}

class _BodyPartsLearningPageState extends State<BodyPartsLearningPage>
    with SingleTickerProviderStateMixin {
  final BodyPartsLearningController controller = Get.put(
    BodyPartsLearningController(),
  );
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                // GridView scrolls inside SingleChildScrollView
                CustomGridViewBuilder(
                  ...
                  items: BodyPartsLearningController.bodyParts,

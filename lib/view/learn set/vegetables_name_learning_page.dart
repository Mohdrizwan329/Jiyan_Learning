...
import 'package:learning_a_to_z/view%20model/learn%20set%20controller/vegetables_learning_controller.dart';
import 'package:learning_a_to_z/view/ads/Google_Ads_Page.dart';
import 'package:learning_a_to_z/widgets/Custom_AppBar_Page.dart';

class VegetablesLearningPage extends StatefulWidget {
  const VegetablesLearningPage({super.key});

  @override
  State<VegetablesLearningPage> createState() => _VegetablesLearningPageState();
}

class _VegetablesLearningPageState extends State<VegetablesLearningPage>
    with SingleTickerProviderStateMixin {
  final VegetablesLearningController controller = Get.put(
    VegetablesLearningController(),
  );
            ...
            child: Column(
              children: [
                ...
                GridView.builder(
                  ...
                  itemCount: VegetablesLearningController.vegetables.length,
                  ...
                  itemBuilder: (context, index) {
                    final item = VegetablesLearningController.vegetables[index];
